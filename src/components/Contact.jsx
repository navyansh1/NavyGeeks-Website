        ...
        <div className="grid md:grid-cols-2 place-items-center gap-4 md:gap-0">
          ...
          <div className="w-full">
            <div className="text-gray-300 my-2 md:my-3">
              ...
              <p className="text-justify text-sm md:text-base leading-6 md:leading-7 w-full md:w-11/12 md:mx-auto">
          ...
          >
            ...
            <input
              ...
              name="name"
              className="mb-2 w-full rounded-md border-2 md:border-4 border-yellow-600 py-1.5 md:py-2 pl-2 pr-4 text-sm md:text-base bg-transparent text-gray-100"
            />
            <input
              type="email"
              id="email"
              ...
              name="email"
              className="mb-3 md:mb-7 w-full rounded-md border-2 md:border-4 border-yellow-600 py-1.5 md:py-2 pl-2 pr-4 text-sm md:text-base bg-transparent text-gray-100"
            />
            <textarea
              name="textarea"
              id="textarea"
              ...
              className="mb-1 w-full rounded-md border-2 md:border-4 border-yellow-600 py-1.5 md:py-2 pl-2 pr-4 text-sm md:text-base bg-transparent text-gray-100"
            />
            <button
              type="submit"
