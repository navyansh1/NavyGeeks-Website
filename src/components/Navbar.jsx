    ...
    return (
        <>
            ...
            <div className="md:hidden">
                ...
                <motion.button
                    onClick={toggleNav}
                    className="fixed bottom-6 right-6 z-[1000] p-3 bg-yellow-400 bg-opacity-60 backdrop-blur-sm rounded-full shadow-lg text-slate-900 w-12 h-12 flex items-center justify-center"
                    whileTap={{ scale: 0.95 }}
                    layout
                >
                    <motion.div
